...
static char cKWListOfFileNameList[][D_CharTmpReadDef]={
  ...
  "InDH2", "InDH4", "InGPW", "InGPWDistWeights", "InRBM", "InOrbital", "InOrbitalAntiParallel",
...
enum KWIdxInt{
  ...
  KWInDH2, KWInDH4, KWInGPW, KWInGPWDistWeights, KWInRBM, KWInOrbital,KWInOrbitalAntiParallel,
...
enum ParamIdxInt{
  ...
  IdxRedCutMode, IdxAltBasisOrder,
  ParamIdxInt_End
};
